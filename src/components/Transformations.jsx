                                ...
                                <div className="md:w-1/2 h-1/2 md:h-full p-8 md:p-10 flex flex-col justify-center overflow-y-auto">
                                    <div className="mb-2">
                                        <span className="text-secondary font-bold tracking-widest uppercase text-sm">
                                            {selectedTransformation.achievement}
                                        </span>
                                    </div>
                                    <h2 className="text-3xl md:text-4xl font-gagalin text-white mb-2">
                                        {selectedTransformation.name}'s Journey
                                    </h2>
                                    ...
                                    <div className="space-y-4 text-gray-300 leading-relaxed">
                                        ...
                                        <p className="opacity-70 text-sm italic border-l-2 border-primary pl-4">
                                            "The hardest part was starting. Once I saw the first results, I was addicted to the progress. Roar Fitness gave me the roadmap I needed."
                                        </p>
                                    </div>
                                    ...
                                    <div className="mt-8 pt-6 border-t border-white/10">
                                        ...
                                        <p className="text-sm text-greyText">
                                            Detailed breakdown of the specific workout split, nutrition macros, and supplement stack used for this transformation coming soon...
                                        </p>
                                    </div>
                                </div>
                            </div>
